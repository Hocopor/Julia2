...
if [ -n "$CONTAINER_ID" ]; then
    ...
    echo "https://ваш-домен.ru/assets/hero-photo.png"
    echo "https://ваш-домен.ru/assets/about-photo.png"
    echo "https://ваш-домен.ru/assets/sea-photo.png"
else
...
echo "3. Проверьте headers: curl -I https://ваш-домен.ru/assets/hero-photo.png"